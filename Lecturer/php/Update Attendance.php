            ...
            <table cellspacing="5px">
                ...
                <tr class="tb">
                    ...
                    <td class="dd">
                        ...
                        <a href="Update Attendance1.php?StuRollno=<?php echo $eno;?>&Stime=<?php echo $stime;?>&Etime=<?php echo $etime;?>&ADate=<?php echo $date;?>&Status=<?php echo $status;?>&Type=<?php echo $type;?>&StuInfo=<?php echo $stuinfo;?>">Update</a>
                    </td>
                </tr>
                <?php
                $counter++;
