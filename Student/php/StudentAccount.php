    ...
    ?>
        ...
        <div class="studentdata">
            ...
            while($row=mysqli_fetch_array($cmd))
            {
                ...
                $branch=mysqli_fetch_array($cmd1);
        ...
        <hr>
            ...
            <?php include('DailyAttendanceTable(StuAcc).php'); ?>
            </div>

            <div id="Monthly1" class="attcontent">
            <?php include('MonthlyAttendanceTable(StuAcc).php'); ?>
            </div>
        </div>
        </center>
        <script>
        ...
        <hr>
            ...
            <?php include('MonthlyAttendanceChart(StuAcc).php'); ?>
            </div>

            <div id="Total" class="chartcontent">
            <?php include('TotalAttendanceChart(StuAcc).php'); ?>
            </div>
        </center>
        <script>
